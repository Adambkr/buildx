...
function LoginForm() {
  ...
  return (
    <div className="min-h-screen bg-[#050507] flex items-center justify-center px-4 py-12 relative overflow-hidden">
      ...
      <div className="absolute top-[-200px] right-[-200px] w-[500px] h-[500px] rounded-full bg-[#FF3366]/10 blur-[120px] pointer-events-none" />
      <div className="absolute bottom-[-200px] left-[-200px] w-[400px] h-[400px] rounded-full bg-[#A855F7]/10 blur-[120px] pointer-events-none" />
      ...
      >
        <div className="glass-dark rounded-2xl border border-white/[0.08] p-8 sm:p-10 shadow-2xl shadow-black/50">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-[#64748B] mt-1 text-sm">Sign in to continue building</p>
          </div>
          ...
          <p className="text-center text-sm text-[#64748B] mt-6">
            ...
            <Link href="/signup" className="font-bold text-[#FF3366] hover:text-[#FF6B9D] transition-colors">
              Sign up free
            </Link>
          </p>
        </div>
